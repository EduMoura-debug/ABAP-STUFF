*&---------------------------------------------------------------------*
*&      Form  F_CHAMAR_WF_APROVAR_TARIFA
*&---------------------------------------------------------------------*
FORM f_chamar_wf_aprovar_tarifa.

  gv_objtype      = 'ZBUSXXXX'. "Business Object
  gv_decision_key = '0001'. "Aprovar
...
***
      ...
      ELSE.
*     Falha na função de decisão para aprovação - Analisar Log
...
*      CLEAR lv_mensagem.
*      MESSAGE e004(zwf) INTO lv_mensagem.
...
ENDFORM.                    " F_CHAMAR_WF_APROVAR_TARIFA